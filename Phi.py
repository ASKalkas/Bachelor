...
# Text = f"""
# You are an experienced instructor specializing in NX Manufacturing CAM software. Your goal is to write a short, introductory course for beginners on how to design a sphere using NX Manufacturing CAM software.
...
with torch.no_grad():
    outputs = Phi_model.generate(**inputs, **generation_kwargs)
...
response = Phi_tokenizer.decode(generated_tokens, skip_special_tokens=True).strip()
